...
1) If a previous version of the Dash Gauges firmware, or any other firmware of the BTTF family ([FC](https://fc.backtothefutu.re), [SID](https://sid.backtothefutu.re), [Dash Gauges](https://dg.backtothefutu.re)), is installed on your device' ESP32, you can update easily using the pre-compiled binary. Enter the [Config Portal](#the-config-portal), click on "Update" and select the pre-compiled binary file provided in this repository ("install/dashgauges-A10001986.ino.nodemcu-32s.bin").
