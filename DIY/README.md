...
- Standard VU meter (Simpson 49L, 142): Internally unmodified. R5=330R, R6=3k3; R11 bridged as the 6V incandescent light bulbs need to resistor. Gauge Tyoe setting "Standard VU-Meter".
- Simpson model 49 voltmeter 0-50V DC (SK 525-447): Internal resistor needs to be bridged. R5=bridged, R6=5k6; R11 depends on user's design of illumination. Gauge Tyoe setting "Generic Analog (0-5V)".
